...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "619d70145cc38a3c517d";
...
class IssueAddNavItem extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  ...
  async handleSubmit(e) {
    ...
    console.log(`Before add query title = ${issue.title} \n owner = ${issue.owner} \n due = ${issue.due}`);
    ...
    if (data) {
      ...
      console.log(`Add query successful ${data.issueAdd.id}`);
    }
  }
...
class IssueList extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  ...
  async loadData() {
    ...
    const data = await Object(_graphQLFetch_js__WEBPACK_IMPORTED_MODULE_6__["default"])(query, vars);
